...
public class App {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            File myObj = new File("src/graph.txt");
            ...
            try {
                File file = new File("src/MainApp/CodePartB/out.txt");
                if (!file.exists()) {
                    file.createNewFile();
                }
